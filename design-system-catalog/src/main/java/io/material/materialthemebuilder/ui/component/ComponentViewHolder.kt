...
import io.material.materialthemebuilder.ui.epoxy.ButtonActivity
...
sealed class ComponentViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
  ...
  class ButtonComponentViewHolder(
    parent: ViewGroup
  ) : ComponentViewHolder(inflate(parent, R.layout.vh_button)){
    override fun bind(component: Component) {
      super.bind(component)
      itemView.setOnClickListener {
        itemView.context.startActivity(Intent(itemView.context, ButtonActivity::class.java))
      }
    }
  }
  ...
  companion object {
    fun create(
      ...
      return when (ComponentsToShow[viewType]) {
